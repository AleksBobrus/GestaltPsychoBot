...
async def main():
    ...
    print("\n" + "=" * 55)
    print("        🤖 ПСИХОЛОГИЧЕСКИЙ ПОМОЩНИК v2.0")
    print("=" * 55)
    print("\n📡 СТАТУС СИСТЕМЫ:")
    ...
    print("\n🎯 АКТИВНЫЕ ФУНКЦИИ:")
    print("  💬 Диалог с ИИ-психологом")
    print("     └─ Лимит: 20 сообщений/день")
    print("     └─ Контекст: 20 последних сообщений")
    print("     └─ Суммаризация каждые 30 сообщений")
    print("  🆘 Детектор кризисных ситуаций")
    print("  ℹ️  Информация о боте")
    print("\n🚧 В РАЗРАБОТКЕ:")
    print("  📋 Тест Бека на депрессию")
    print("  🌱 Техники заземления (4-7-8, 5-4-3-2-1)")
    print("  👤 Личный кабинет с историей")
    print("\n" + "=" * 55)
