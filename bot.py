...
async def cmd_start(message: types.Message, state: FSMContext):
    ...
    await message.answer(
        "🌟 <b>Добро пожаловать в психологического помощника!</b>\n\n"
        "Я создан на основе подходов <b>гештальт-терапии</b> и <b>когнитивно-поведенческой терапии (КПТ)</b>. "
        "Я могу поддержать, задать вопросы и помочь разобраться в мыслях.\n\n"
        "<b>Что я умею:</b>\n"
        "💬 <b>Поговорить</b> – свободная беседа с ИИ-психологом (гештальт + КПТ)\n"
        "📋 <b>Пройти тест</b> – тест Бека на депрессию (21 вопрос, интерпретация)\n"
        "🧘 <b>Хочу упражнение</b> – дыхательные и релаксационные техники\n"
        "😰 <b>Мне тревожно</b> – техники совладания с тревогой\n"
        "🆘 <b>Кризисная помощь</b> – если вы пишете о суицидальных мыслях, бот даст телефоны доверия\n\n"
        "⚠️ <b>Важно:</b> <tg-spoiler>я не заменяю профессионального психотерапевта.</tg-spoiler> "
        "<tg-spoiler>При серьёзных трудностях обратитесь к специалисту.</tg-spoiler>\n\n"
